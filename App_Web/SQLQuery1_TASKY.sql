...
----1.Tabla Usuario (Gesti�n de cuentas, perfiles y suscripcion)----
 ...
 Nivel_suscripcion NVARCHAR(50) DEFAULT 'Basico'  ----Campo para la gesti�n de suscripci�n (B�sico/Primium)---
 );
 ...
 -- Campo para organizar las tareas por categor�a (Ej: 'Universidad', 'Trabajo')
...
FOREIGN KEY (ID_usuario) REFERENCES Usuario(ID_usuario)  ON DELETE CASCADE
 ...
 Fecha_fin DATETIME2,
 Tipo NVARCHAR(50),  -- 'Clase', 'Reuni�n', 'Examen', 'Otro' ---
